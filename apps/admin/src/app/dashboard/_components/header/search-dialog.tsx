...
import type { NavGroup, NavMainItem } from "@/types";
...
// The bottom-pinned items are navigation too, so they belong in the palette.
const searchGroups: NavGroup[] = [...sidebarItems, { id: 0, label: "General", items: sidebarSecondaryItems }];

const searchItems: SearchItem[] = searchGroups.flatMap((group) =>
